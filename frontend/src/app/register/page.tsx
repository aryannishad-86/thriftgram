...
export default function RegisterPage() {
    ...
    return (
        <main className="relative flex min-h-screen flex-col items-center justify-center bg-background p-4 selection:bg-primary/20">
            <motion.div
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
                            <Input
                                ...
                                className="h-12 hover:border-primary/50"
                            />
                        </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.85 }}>
                        <Button
                            ...
                            className="w-full hover:border-primary hover:bg-transparent hover:text-foreground"
                        >
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} className="text-center text-sm">
                        <span className="text-muted">Already have an account? </span>
                        <Link href="/login" className="group relative font-medium text-foreground transition-colors hover:text-accent">
                            Sign in
                            <span className="absolute -bottom-0.5 left-0 h-0.5 w-0 bg-accent transition-all group-hover:w-full" />
                        </Link>
                    </motion.div>
                </form>
            </motion.div>

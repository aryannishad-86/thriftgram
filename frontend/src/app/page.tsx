    ...
    <main className="min-h-screen bg-background selection:bg-primary/20">
      ...
      <div className="relative overflow-hidden border-b border-border py-24 sm:py-32 isolate">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-5xl font-bold tracking-tight text-base-01 sm:text-7xl">
            Future of Thrifting.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-base-00">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="/sell" className="text-sm font-semibold leading-6 text-primary hover:text-secondary transition-colors">
      ...
      <div id="feed" className="container mx-auto px-4 py-16">
        <div className="mb-10 flex items-center justify-between">
          <h2 className="text-2xl font-bold tracking-tight text-base-01">
            Trending Now
          </h2>
          <div className="flex gap-2">
            {['All', 'Vintage', 'Streetwear', 'Y2K'].map((filter) => (
              <button key={filter} className="rounded-full border border-border bg-background px-4 py-1 text-xs font-medium text-muted hover:bg-base-2 hover:text-foreground transition-all">
                {filter}
              </button>
            ))}
          </div>
